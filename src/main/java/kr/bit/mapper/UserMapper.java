...
public interface UserMapper {
    ...
    @Insert("insert into user_profiles (user_id, gender, birth_date, height, weight, religion, mbti, drinking_level, smoking_status) " +
            "values(#{userId}, #{gender}, #{birthDate}, #{height}, #{weight}, #{religion}, #{mbti}, #{drinkingLevel}, #{smokingStatus})")
